    ...
    <div className="mx-auto w-full max-w-4xl px-4 py-16">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg leading-relaxed text-gray-300">
          Los <span className="font-semibold text-white">Albion Awards</span> son los primeros premios dedicados a reconocer
          el talento y dedicación de los <span className="font-semibold text-white">streamers</span> y{' '}
          <span className="font-semibold text-white">creadores de contenido</span> de Albion Online en la comunidad hispanohablante.
        </p>
        <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-gray-400">
          Una celebración del entretenimiento, la creatividad y los momentos memorables que hacen grande a nuestra comunidad.
        </p>
      </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-purple-500/30 bg-black/30 p-6 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:border-purple-400/50 hover:bg-black/40">
            ...
            <div className="relative">
              ...
              <p className="mb-4 text-sm text-gray-400">Streamer de Albion Online</p>
              <a

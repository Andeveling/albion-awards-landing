	...
	return (
		...
		>
			...
			<div className="relative flex flex-col items-center gap-4 text-center">
				{/* Icon */}
				<div
					className={`flex h-16 w-16 items-center justify-center rounded-full bg-white/10 backdrop-blur-sm transition-transform duration-300 group-hover:scale-110 bg-linear-to-br ${colorClass.split(" ")[0]} ${colorClass.split(" ")[1]}`}
				>
				...
				{/* Name */}
				<h3
					className={`text-xl font-bold uppercase tracking-wide text-transparent bg-linear-to-br ${textGradient} bg-clip-text md:text-2xl`}
				>
					{category.name}
				</h3>
